...
//                    "cleared-by");
    ...
    case STM32_FAMILY_F1:
        ...
        if (capabilities->f1.is_103xx) {
            ...
            cm_object_property_set_str(state->u.f1.fld.cfgr.sws, "SW",
                    "follows");
            ...
            cm_object_property_set_str(state->u.f1.cr.pllrdy, "pllon", "follows");
            cm_object_property_set_str(state->u.f1.cr.pll2rdy, "pll2on",
                    "follows");
            cm_object_property_set_str(state->u.f1.cr.pll3rdy, "pll3on",
                    "follows");

            cm_object_property_set_str(state->u.f1.cfgr.sws, "sw", "follows");

            cm_object_property_set_str(state->u.f1.cir.lsirdyf, "lsirdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.lserdyf, "lserdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.hsirdyf, "hsirdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.hserdyf, "hserdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.pllrdyf, "pllrdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.pll2rdyf, "pll2rdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.pll3rdyf, "pll3rdyc",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.cir.cssf, "cssc",
                    "cleared-by");

            cm_object_property_set_str(state->u.f1.bdcr.lserdy, "lseon",
                    "follows");

            cm_object_property_set_str(state->u.f1.csr.lsirdy, "lsion",
                    "follows");
            cm_object_property_set_str(state->u.f1.csr.pinrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.csr.porrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.csr.stfrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.csr.iwdgrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.csr.wwdgrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f1.csr.lrwrrstf, "rmvf",
                    "cleared-by");
#endif
        } else {
            assert(false);
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_40x) {
            ...
            cm_object_property_set_str(state->u.f4.fld.cfgr.sws, "SW",
                    "follows");
            ...
            cm_object_property_set_str(state->u.f4.fld.cir.pllrdyf, "PLLRDYC",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.cir.plli2srdyf,
            ...
            cm_object_property_set_str(state->u.f4.fld.csr.lsirdy, "lsion",
                    "follows");
            cm_object_property_set_str(state->u.f4.fld.csr.pinrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.csr.porrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.csr.stfrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.csr.iwdgrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.csr.wwdgrstf, "rmvf",
                    "cleared-by");
            cm_object_property_set_str(state->u.f4.fld.csr.lpwrrstf, "rmvf",
