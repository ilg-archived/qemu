...
#define DEVICE_PATH_STM32_USB_OTG_HOSTDEVICE_PATH_STM32"USB_OTG_HOST"

// ----------------------------------------------------------------------------

#define TYPE_STM32_USB_OTG_HOSTTYPE_STM32_PREFIX "usb_otg_host" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F1USB_OTG_HOST(USB on the go full speed) registers.
        struct { 
