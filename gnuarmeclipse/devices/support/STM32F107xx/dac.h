...
union {
      ...
      struct {
        // F1DAC(Digital to analog converter) registers.
        struct { 
...
// DHR12LD(DUAL DAC 12-bit left aligned data holding register (DAC_DHR12LD), Bits 19:16 Reserved, Bits 3:0 Reserved) bitfields.
          struct { 
Object *dacc1dhr; // [4:15] DAC channel1 12-bit left-aligned dataObject *dacc2dhr; // [20:31] DAC channel2 12-bit right-aligned data} dhr12ld; 
