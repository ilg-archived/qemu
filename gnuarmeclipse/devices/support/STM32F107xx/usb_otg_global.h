...
#define DEVICE_PATH_STM32_USB_OTG_GLOBALDEVICE_PATH_STM32"USB_OTG_GLOBAL"

// ----------------------------------------------------------------------------

#define TYPE_STM32_USB_OTG_GLOBALTYPE_STM32_PREFIX "usb_otg_global" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F1USB_OTG_GLOBAL(USB on the go full speed) registers.
        struct { 
...
// FS_GUSBCFG(OTG_FS USB configuration register (OTG_FS_GUSBCFG)) bitfields.
          struct { 
Object *tocal; // [0:2] FS timeout calibrationObject *physel; // [7:7] Full Speed serial transceiver selectObject *srpcap; // [8:8] SRP-capableObject *hnpcap; // [9:9] HNP-capableObject *trdt; // [10:13] USB turnaround timeObject *fhmod; // [29:29] Force host modeObject *fdmod; // [30:30] Force device modeObject *ctxpkt; // [31:31] Corrupt Tx packet} fs_gusbcfg; 
