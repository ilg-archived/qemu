...
#define DEVICE_PATH_STM32_BKPDEVICE_PATH_STM32"BKP"

// ----------------------------------------------------------------------------

#define TYPE_STM32_BKPTYPE_STM32_PREFIX "bkp" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F1BKP(Backup registers) registers.
        struct { 
