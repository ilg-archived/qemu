...
#define DEVICE_PATH_STM32_CAN2DEVICE_PATH_STM32"CAN2"

// ----------------------------------------------------------------------------

#define TYPE_STM32_CAN2TYPE_STM32_PREFIX "can2" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F1CAN2(Controller area network) registers.
        struct { 
