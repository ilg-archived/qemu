...
typedef struct {
    ...
    union {
      ...
      struct {
        ...
        struct { 
          Object *sr; // 0x0 (UART4 SR) 
          Object *dr; // 0x4 (UART4 DR) 
          Object *brr; // 0x8 (UART4 BRR) 
          Object *cr1; // 0xC (UART4 CR1) 
          Object *cr2; // 0x10 (UART4 CR2) 
          Object *cr3; // 0x14 (UART4 CR3) 
        } reg;

        struct { 
          
          // SR (UART4 SR) bitfields.
          struct { 
