...
#define DEVICE_PATH_STM32_FSMCDEVICE_PATH_STM32"FSMC"

// ----------------------------------------------------------------------------

#define TYPE_STM32_FSMCTYPE_STM32_PREFIX "fsmc" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F1FSMC(Flexible static memory controller) registers.
        struct { 
...
// PATT2(Attribute memory space timing register 2) bitfields.
          struct { 
Object *attsetx; // [0:7] Attribute memory x setup timeObject *attwaitx; // [8:15] Attribute memory x wait timeObject *attholdx; // [16:23] Attribute memory x hold timeObject *atthizx; // [24:31] Attribute memory x databus HiZ time} patt2; 
// ECCR2(ECC result register 2) bitfields.
          struct { 
Object *eccx; // [0:31] ECC result} eccr2; 
