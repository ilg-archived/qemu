...
union {
      ...
      struct {
        // F4ADC(Analog-to-digital converter) registers.
        struct { 
...
// SR(Status register) bitfields.
          struct { 
Object *awd; // [0:0] Analog watchdog flagObject *eoc; // [1:1] Regular channel end of conversionObject *jeoc; // [2:2] Injected channel end of conversionObject *jstrt; // [3:3] Injected channel start flagObject *strt; // [4:4] Regular channel start flagObject *ovr; // [5:5] Overrun} sr; 
// CR1(Control register 1) bitfields.
          struct { 
Object *awdch; // [0:4] Analog watchdog channel select bitsObject *eocie; // [5:5] Interrupt enable for EOCObject *awdie; // [6:6] Analog watchdog interrupt enableObject *jeocie; // [7:7] Interrupt enable for injected channelsObject *scan; // [8:8] Scan modeObject *awdsgl; // [9:9] Enable the watchdog on a single channel in scan modeObject *jauto; // [10:10] Automatic injected group conversionObject *discen; // [11:11] Discontinuous mode on regular channelsObject *jdiscen; // [12:12] Discontinuous mode on injected channelsObject *discnum; // [13:15] Discontinuous mode channel countObject *jawden; // [22:22] Analog watchdog enable on injected channelsObject *awden; // [23:23] Analog watchdog enable on regular channelsObject *res; // [24:25] ResolutionObject *ovrie; // [26:26] Overrun interrupt enable} cr1; 
// CR2(Control register 2) bitfields.
          struct { 
Object *adon; // [0:0] A/D Converter ON / OFFObject *cont; // [1:1] Continuous conversionObject *dma; // [8:8] Direct memory access mode (for single ADC mode)Object *dds; // [9:9] DMA disable selection (for single ADC mode)Object *eocs; // [10:10] End of conversion selectionObject *align; // [11:11] Data alignmentObject *jextsel; // [16:19] External event select for injected groupObject *jexten; // [20:21] External trigger enable for injected channelsObject *jswstart; // [22:22] Start conversion of injected channelsObject *extsel; // [24:27] External event select for regular groupObject *exten; // [28:29] External trigger enable for regular channelsObject *swstart; // [30:30] Start conversion of regular channels} cr2; 
// SMPR1(Sample time register 1) bitfields.
          struct { 
Object *smpx_x; // [0:31] Sample time bits} smpr1; 
// SMPR2(Sample time register 2) bitfields.
          struct { 
Object *smpx_x; // [0:31] Sample time bits} smpr2; 
