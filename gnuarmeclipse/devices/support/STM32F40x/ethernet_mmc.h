...
union {
      ...
      struct {
        // F4Ethernet_MMC(Ethernet: MAC management counters) registers.
        struct { 
...
// MMCCR(Ethernet MMC control register) bitfields.
          struct { 
Object *cr; // [0:0] No description availableObject *csr; // [1:1] No description availableObject *ror; // [2:2] No description availableObject *mcf; // [3:3] No description availableObject *mcp; // [4:4] No description availableObject *mcfhp; // [5:5] No description available} mmccr; 
// MMCRIR(Ethernet MMC receive interrupt register) bitfields.
          struct { 
Object *rfces; // [5:5] No description availableObject *rfaes; // [6:6] No description availableObject *rgufs; // [17:17] No description available} mmcrir; 
// MMCTIR(Ethernet MMC transmit interrupt register) bitfields.
          struct { 
Object *tgfscs; // [14:14] No description availableObject *tgfmscs; // [15:15] No description availableObject *tgfs; // [21:21] No description available} mmctir; 
// MMCRIMR(Ethernet MMC receive interrupt mask register) bitfields.
          struct { 
Object *rfcem; // [5:5] No description availableObject *rfaem; // [6:6] No description availableObject *rgufm; // [17:17] No description available} mmcrimr; 
// MMCTIMR(Ethernet MMC transmit interrupt mask register) bitfields.
          struct { 
Object *tgfscm; // [14:14] No description availableObject *tgfmscm; // [15:15] No description availableObject *tgfm; // [16:16] No description available} mmctimr; 
// MMCTGFSCCR(Ethernet MMC transmitted good frames after a single collision counter) bitfields.
          struct { 
Object *tgfscc; // [0:31] No description available} mmctgfsccr; 
// MMCTGFMSCCR(Ethernet MMC transmitted good frames after more than a single collision) bitfields.
          struct { 
Object *tgfmscc; // [0:31] No description available} mmctgfmsccr; 
// MMCTGFCR(Ethernet MMC transmitted good frames counter register) bitfields.
          struct { 
Object *tgfc; // [0:31] HTL} mmctgfcr; 
// MMCRFCECR(Ethernet MMC received frames with CRC error counter register) bitfields.
          struct { 
Object *rfcfc; // [0:31] No description available} mmcrfcecr; 
// MMCRFAECR(Ethernet MMC received frames with alignment error counter register) bitfields.
          struct { 
Object *rfaec; // [0:31] No description available} mmcrfaecr; 
// MMCRGUFCR(MMC received good unicast frames counter register) bitfields.
          struct { 
Object *rgufc; // [0:31] No description available} mmcrgufcr; 
} fld;
      } f4;
