...
union {
      ...
      struct {
        // F4RTC(Real-time clock) registers.
        struct { 
...
// CR(Control register) bitfields.
          struct { 
Object *wcksel; // [0:2] Wakeup clock selectionObject *tsedge; // [3:3] Time-stamp event active edgeObject *refckon; // [4:4] Reference clock detection enable (50 or 60 Hz)Object *fmt; // [6:6] Hour formatObject *dce; // [7:7] Coarse digital calibration enableObject *alrae; // [8:8] Alarm A enableObject *alrbe; // [9:9] Alarm B enableObject *wute; // [10:10] Wakeup timer enableObject *tse; // [11:11] Time stamp enableObject *alraie; // [12:12] Alarm A interrupt enableObject *alrbie; // [13:13] Alarm B interrupt enableObject *wutie; // [14:14] Wakeup timer interrupt enableObject *tsie; // [15:15] Time-stamp interrupt enableObject *add1h; // [16:16] Add 1 hour (summer time change)Object *sub1h; // [17:17] Subtract 1 hour (winter time change)Object *bkp; // [18:18] BackupObject *pol; // [20:20] Output polarityObject *osel; // [21:22] Output selectionObject *coe; // [23:23] Calibration output enable} cr; 
// ISR(Initialization and status register) bitfields.
          struct { 
Object *alrawf; // [0:0] Alarm A write flagObject *alrbwf; // [1:1] Alarm B write flagObject *wutwf; // [2:2] Wakeup timer write flagObject *shpf; // [3:3] Shift operation pendingObject *inits; // [4:4] Initialization status flagObject *rsf; // [5:5] Registers synchronization flagObject *initf; // [6:6] Initialization flagObject *init; // [7:7] Initialization modeObject *alraf; // [8:8] Alarm A flagObject *alrbf; // [9:9] Alarm B flagObject *wutf; // [10:10] Wakeup timer flagObject *tsf; // [11:11] Time-stamp flagObject *tsovf; // [12:12] Time-stamp overflow flagObject *tamp1f; // [13:13] Tamper detection flagObject *tamp2f; // [14:14] TAMPER2 detection flagObject *recalpf; // [16:16] Recalibration pending Flag} isr; 
...
// WUTR(Wakeup timer register) bitfields.
          struct { 
Object *wut; // [0:15] Wakeup auto-reload value bits} wutr; 
// CALIBR(Calibration register) bitfields.
          struct { 
Object *dc; // [0:4] Digital calibrationObject *dcs; // [7:7] Digital calibration sign} calibr; 
// ALRMAR(Alarm A register) bitfields.
          struct { 
Object *su; // [0:3] Second units in BCD formatObject *st; // [4:6] Second tens in BCD formatObject *msk1; // [7:7] Alarm A seconds maskObject *mnu; // [8:11] Minute units in BCD formatObject *mnt; // [12:14] Minute tens in BCD formatObject *msk2; // [15:15] Alarm A minutes maskObject *hu; // [16:19] Hour units in BCD formatObject *ht; // [20:21] Hour tens in BCD formatObject *pm; // [22:22] AM/PM notationObject *msk3; // [23:23] Alarm A hours maskObject *du; // [24:27] Date units or day in BCD formatObject *dt; // [28:29] Date tens in BCD formatObject *wdsel; // [30:30] Week day selectionObject *msk4; // [31:31] Alarm A date mask} alrmar; 
// ALRMBR(Alarm B register) bitfields.
          struct { 
Object *su; // [0:3] Second units in BCD formatObject *st; // [4:6] Second tens in BCD formatObject *msk1; // [7:7] Alarm B seconds maskObject *mnu; // [8:11] Minute units in BCD formatObject *mnt; // [12:14] Minute tens in BCD formatObject *msk2; // [15:15] Alarm B minutes maskObject *hu; // [16:19] Hour units in BCD formatObject *ht; // [20:21] Hour tens in BCD formatObject *pm; // [22:22] AM/PM notationObject *msk3; // [23:23] Alarm B hours maskObject *du; // [24:27] Date units or day in BCD formatObject *dt; // [28:29] Date tens in BCD formatObject *wdsel; // [30:30] Week day selectionObject *msk4; // [31:31] Alarm B date mask} alrmbr; 
...
// SHIFTR(Shift control register) bitfields.
          struct { 
Object *subfs; // [0:14] Subtract a fraction of a secondObject *add1s; // [31:31] Add one second} shiftr; 
// TSTR(Time stamp time register) bitfields.
          struct { 
Object *tamp1e; // [0:0] Tamper 1 detection enableObject *tamp1trg; // [1:1] Active level for tamper 1Object *tampie; // [2:2] Tamper interrupt enableObject *tamp1insel; // [16:16] TAMPER1 mappingObject *tsinsel; // [17:17] TIMESTAMP mappingObject *alarmouttype; // [18:18] AFO_ALARM output type} tstr; 
...
// CALR(Calibration register) bitfields.
          struct { 
Object *calm; // [0:8] Calibration minusObject *calw16; // [13:13] Use a 16-second calibration cycle periodObject *calw8; // [14:14] Use an 8-second calibration cycle periodObject *calp; // [15:15] Increase frequency of RTC by 488.5 ppm} calr; 
// TAFCR(Tamper and alternate function configuration register) bitfields.
          struct { 
Object *tamp1e; // [0:0] Tamper 1 detection enableObject *tamp1trg; // [1:1] Active level for tamper 1Object *tampie; // [2:2] Tamper interrupt enableObject *tamp2e; // [3:3] Tamper 2 detection enableObject *tamp2trg; // [4:4] Active level for tamper 2Object *tampts; // [7:7] Activate timestamp on tamper detection eventObject *tampfreq; // [8:10] Tamper sampling frequencyObject *tampflt; // [11:12] Tamper filter countObject *tampprch; // [13:14] Tamper precharge durationObject *tamppudis; // [15:15] TAMPER pull-up disableObject *tamp1insel; // [16:16] TAMPER1 mappingObject *tsinsel; // [17:17] TIMESTAMP mappingObject *alarmouttype; // [18:18] AFO_ALARM output type} tafcr; 
...
// ALRMBSSR(Alarm B sub second register) bitfields.
          struct { 
Object *ss; // [0:14] Sub seconds valueObject *maskss; // [24:27] Mask the most-significant bits starting at this bit} alrmbssr; 
