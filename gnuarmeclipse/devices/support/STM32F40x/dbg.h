...
// DBGMCU_CR(Control Register) bitfields.
          struct { 
Object *dbg_sleep; // [0:0] DBG_SLEEPObject *dbg_stop; // [1:1] DBG_STOPObject *dbg_standby; // [2:2] DBG_STANDBYObject *trace_ioen; // [5:5] TRACE_IOENObject *trace_mode; // [6:7] TRACE_MODEObject *dbg_i2c2_smbus_timeout; // [16:16] DBG_I2C2_SMBUS_TIMEOUTObject *dbg_tim8_stop; // [17:17] DBG_TIM8_STOPObject *dbg_tim5_stop; // [18:18] DBG_TIM5_STOPObject *dbg_tim6_stop; // [19:19] DBG_TIM6_STOPObject *dbg_tim7_stop; // [20:20] DBG_TIM7_STOP} dbgmcu_cr; 
