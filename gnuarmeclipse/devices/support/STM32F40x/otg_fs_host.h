...
#define DEVICE_PATH_STM32_OTG_FS_HOST DEVICE_PATH_STM32 "OTG_FS_HOST"

// ----------------------------------------------------------------------------

// Note: the "port-index" property has type "int".
typedef enum {
    STM32_OTG_FS_HOST_PORT_1 = 0,
    // TODO add all other peripherals in this group
    STM32_OTG_FS_HOST_PORT_UNDEFINED = 0xFF,
} stm32_otg_fs_host_index_t;

// ----------------------------------------------------------------------------

#define TYPE_STM32_OTG_FS_HOST TYPE_STM32_PREFIX "otg_fs_host" TYPE_PERIPHERAL_SUFFIX
