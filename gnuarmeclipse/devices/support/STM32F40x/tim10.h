...
#define DEVICE_PATH_STM32_TIM10DEVICE_PATH_STM32"TIM10"

// ----------------------------------------------------------------------------

#define TYPE_STM32_TIM10TYPE_STM32_PREFIX "tim10" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F4TIM10(General-purpose-timers) registers.
        struct { 
