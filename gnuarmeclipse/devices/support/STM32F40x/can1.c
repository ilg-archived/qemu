...
static void stm32f40x_can_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
static void stm32_can_instance_init_callback(Object *obj)
{
    ...
    state->port_index = STM32_CAN_PORT_UNDEFINED;
...
static void stm32_can_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_40x ) {
            ...
            stm32f40x_can_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            snprintf(enabling_bit_name, sizeof(enabling_bit_name) - 1,
                ...
                state->port_index - STM32_CAN_PORT_A + 1);
