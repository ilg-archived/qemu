...
#define DEVICE_PATH_STM32_OTG_HS_HOSTDEVICE_PATH_STM32"OTG_HS_HOST"

// ----------------------------------------------------------------------------

#define TYPE_STM32_OTG_HS_HOSTTYPE_STM32_PREFIX "otg_hs_host" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F4OTG_HS_HOST(USB on the go high speed) registers.
        struct { 
...
// OTG_HS_HCFG(OTG_HS host configuration register) bitfields.
          struct { 
Object *fslspcs; // [0:1] FS/LS PHY clock selectObject *fslss; // [2:2] FS- and LS-only support} otg_hs_hcfg; 
// OTG_HS_HFIR(OTG_HS Host frame interval register) bitfields.
          struct { 
Object *frivl; // [0:15] Frame interval} otg_hs_hfir; 
// OTG_HS_HFNUM(OTG_HS host frame number/frame time remaining register) bitfields.
          struct { 
Object *frnum; // [0:15] Frame numberObject *ftrem; // [16:31] Frame time remaining} otg_hs_hfnum; 
// OTG_HS_HPTXSTS(OTG_HS_Host periodic transmit FIFO/queue status register) bitfields.
          struct { 
Object *ptxfsavl; // [0:15] Periodic transmit data FIFO space availableObject *ptxqsav; // [16:23] Periodic transmit request queue space availableObject *ptxqtop; // [24:31] Top of the periodic transmit request queue} otg_hs_hptxsts; 
// OTG_HS_HAINT(OTG_HS Host all channels interrupt register) bitfields.
          struct { 
Object *haint; // [0:15] Channel interrupts} otg_hs_haint; 
// OTG_HS_HAINTMSK(OTG_HS host all channels interrupt mask register) bitfields.
          struct { 
Object *haintm; // [0:15] Channel interrupt mask} otg_hs_haintmsk; 
// OTG_HS_HPRT(OTG_HS host port control and status register) bitfields.
          struct { 
Object *pcsts; // [0:0] Port connect statusObject *pcdet; // [1:1] Port connect detectedObject *pena; // [2:2] Port enableObject *penchng; // [3:3] Port enable/disable changeObject *poca; // [4:4] Port overcurrent activeObject *pocchng; // [5:5] Port overcurrent changeObject *pres; // [6:6] Port resumeObject *psusp; // [7:7] Port suspendObject *prst; // [8:8] Port resetObject *plsts; // [10:11] Port line statusObject *ppwr; // [12:12] Port powerObject *ptctl; // [13:16] Port test controlObject *pspd; // [17:18] Port speed} otg_hs_hprt; 
// OTG_HS_HCCHAR0(OTG_HS host channel-0 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar0; 
// OTG_HS_HCCHAR1(OTG_HS host channel-1 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar1; 
// OTG_HS_HCCHAR2(OTG_HS host channel-2 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar2; 
// OTG_HS_HCCHAR3(OTG_HS host channel-3 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar3; 
// OTG_HS_HCCHAR4(OTG_HS host channel-4 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar4; 
// OTG_HS_HCCHAR5(OTG_HS host channel-5 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar5; 
// OTG_HS_HCCHAR6(OTG_HS host channel-6 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar6; 
// OTG_HS_HCCHAR7(OTG_HS host channel-7 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar7; 
// OTG_HS_HCCHAR8(OTG_HS host channel-8 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar8; 
// OTG_HS_HCCHAR9(OTG_HS host channel-9 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar9; 
// OTG_HS_HCCHAR10(OTG_HS host channel-10 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar10; 
// OTG_HS_HCCHAR11(OTG_HS host channel-11 characteristics register) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mc; // [20:21] Multi Count (MC) / Error Count (EC)Object *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} otg_hs_hcchar11; 
// OTG_HS_HCSPLT0(OTG_HS host channel-0 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt0; 
// OTG_HS_HCSPLT1(OTG_HS host channel-1 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt1; 
// OTG_HS_HCSPLT2(OTG_HS host channel-2 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt2; 
// OTG_HS_HCSPLT3(OTG_HS host channel-3 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt3; 
// OTG_HS_HCSPLT4(OTG_HS host channel-4 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt4; 
// OTG_HS_HCSPLT5(OTG_HS host channel-5 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt5; 
// OTG_HS_HCSPLT6(OTG_HS host channel-6 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt6; 
// OTG_HS_HCSPLT7(OTG_HS host channel-7 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt7; 
// OTG_HS_HCSPLT8(OTG_HS host channel-8 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt8; 
// OTG_HS_HCSPLT9(OTG_HS host channel-9 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt9; 
// OTG_HS_HCSPLT10(OTG_HS host channel-10 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt10; 
// OTG_HS_HCSPLT11(OTG_HS host channel-11 split control register) bitfields.
          struct { 
Object *prtaddr; // [0:6] Port addressObject *hubaddr; // [7:13] Hub addressObject *xactpos; // [14:15] XACTPOSObject *complsplt; // [16:16] Do complete splitObject *spliten; // [31:31] Split enable} otg_hs_hcsplt11; 
// OTG_HS_HCINT0(OTG_HS host channel-11 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint0; 
// OTG_HS_HCINT1(OTG_HS host channel-1 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint1; 
// OTG_HS_HCINT2(OTG_HS host channel-2 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint2; 
// OTG_HS_HCINT3(OTG_HS host channel-3 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint3; 
// OTG_HS_HCINT4(OTG_HS host channel-4 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint4; 
// OTG_HS_HCINT5(OTG_HS host channel-5 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint5; 
// OTG_HS_HCINT6(OTG_HS host channel-6 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint6; 
// OTG_HS_HCINT7(OTG_HS host channel-7 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint7; 
// OTG_HS_HCINT8(OTG_HS host channel-8 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint8; 
// OTG_HS_HCINT9(OTG_HS host channel-9 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint9; 
// OTG_HS_HCINT10(OTG_HS host channel-10 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint10; 
// OTG_HS_HCINT11(OTG_HS host channel-11 interrupt register) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *ahberr; // [2:2] AHB errorObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *nyet; // [6:6] Response received interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} otg_hs_hcint11; 
// OTG_HS_HCINTMSK0(OTG_HS host channel-11 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk0; 
// OTG_HS_HCINTMSK1(OTG_HS host channel-1 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk1; 
// OTG_HS_HCINTMSK2(OTG_HS host channel-2 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk2; 
// OTG_HS_HCINTMSK3(OTG_HS host channel-3 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk3; 
// OTG_HS_HCINTMSK4(OTG_HS host channel-4 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk4; 
// OTG_HS_HCINTMSK5(OTG_HS host channel-5 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk5; 
// OTG_HS_HCINTMSK6(OTG_HS host channel-6 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk6; 
// OTG_HS_HCINTMSK7(OTG_HS host channel-7 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk7; 
// OTG_HS_HCINTMSK8(OTG_HS host channel-8 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk8; 
// OTG_HS_HCINTMSK9(OTG_HS host channel-9 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk9; 
// OTG_HS_HCINTMSK10(OTG_HS host channel-10 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk10; 
// OTG_HS_HCINTMSK11(OTG_HS host channel-11 interrupt mask register) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *ahberr; // [2:2] AHB errorObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} otg_hs_hcintmsk11; 
// OTG_HS_HCTSIZ0(OTG_HS host channel-11 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz0; 
// OTG_HS_HCTSIZ1(OTG_HS host channel-1 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz1; 
// OTG_HS_HCTSIZ2(OTG_HS host channel-2 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz2; 
// OTG_HS_HCTSIZ3(OTG_HS host channel-3 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz3; 
// OTG_HS_HCTSIZ4(OTG_HS host channel-4 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz4; 
// OTG_HS_HCTSIZ5(OTG_HS host channel-5 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz5; 
// OTG_HS_HCTSIZ6(OTG_HS host channel-6 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz6; 
// OTG_HS_HCTSIZ7(OTG_HS host channel-7 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz7; 
// OTG_HS_HCTSIZ8(OTG_HS host channel-8 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz8; 
// OTG_HS_HCTSIZ9(OTG_HS host channel-9 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz9; 
// OTG_HS_HCTSIZ10(OTG_HS host channel-10 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz10; 
// OTG_HS_HCTSIZ11(OTG_HS host channel-11 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} otg_hs_hctsiz11; 
// OTG_HS_HCDMA0(OTG_HS host channel-0 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma0; 
// OTG_HS_HCDMA1(OTG_HS host channel-1 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma1; 
// OTG_HS_HCDMA2(OTG_HS host channel-2 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma2; 
// OTG_HS_HCDMA3(OTG_HS host channel-3 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma3; 
// OTG_HS_HCDMA4(OTG_HS host channel-4 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma4; 
// OTG_HS_HCDMA5(OTG_HS host channel-5 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma5; 
// OTG_HS_HCDMA6(OTG_HS host channel-6 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma6; 
// OTG_HS_HCDMA7(OTG_HS host channel-7 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma7; 
// OTG_HS_HCDMA8(OTG_HS host channel-8 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma8; 
// OTG_HS_HCDMA9(OTG_HS host channel-9 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma9; 
// OTG_HS_HCDMA10(OTG_HS host channel-10 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma10; 
// OTG_HS_HCDMA11(OTG_HS host channel-11 DMA address register) bitfields.
          struct { 
Object *dmaaddr; // [0:31] DMA address} otg_hs_hcdma11; 
} fld;
      } f4;
