...
#ifndef STM32_OTG_FS_DEVICE_H_
#define STM32_OTG_FS_DEVICE_H_
...
#define DEVICE_PATH_STM32_OTG_FS_DEVICE DEVICE_PATH_STM32 "OTG_FS_DEVICE"

// ----------------------------------------------------------------------------

// Note: the "port-index" property has type "int".
typedef enum {
    STM32_OTG_FS_DEVICE_PORT_1 = 0,
    // TODO add all other peripherals in this group
    STM32_OTG_FS_DEVICE_PORT_UNDEFINED = 0xFF,
} stm32_otg_fs_device_index_t;

// ----------------------------------------------------------------------------

#define TYPE_STM32_OTG_FS_DEVICE TYPE_STM32_PREFIX "otg_fs_device" TYPE_PERIPHERAL_SUFFIX

// ----------------------------------------------------------------------------

// Parent definitions.
#define TYPE_STM32_OTG_FS_DEVICE_PARENT TYPE_PERIPHERAL
typedef PeripheralClass STM32OTG_FS_DEVICEParentClass;
typedef PeripheralState STM32OTG_FS_DEVICEParentState;

// ----------------------------------------------------------------------------

// Class definitions.
#define STM32_OTG_FS_DEVICE_GET_CLASS(obj) \
    OBJECT_GET_CLASS(STM32OTG_FS_DEVICEClass, (obj), TYPE_STM32_OTG_FS_DEVICE)
#define STM32_OTG_FS_DEVICE_CLASS(klass) \
    OBJECT_CLASS_CHECK(STM32OTG_FS_DEVICEClass, (klass), TYPE_STM32_OTG_FS_DEVICE)

typedef struct {
    // private: 
    STM32OTG_FS_DEVICEParentClass parent_class;
    // public: 

    // None, so far.
} STM32OTG_FS_DEVICEClass;

// ----------------------------------------------------------------------------

// Instance definitions.
#define STM32_OTG_FS_DEVICE_STATE(obj) \
    OBJECT_CHECK(STM32OTG_FS_DEVICEState, (obj), TYPE_STM32_OTG_FS_DEVICE)

typedef struct {
    // private:
    STM32OTG_FS_DEVICEParentState parent_obj;
    // public:
