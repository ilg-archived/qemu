...
#define DEVICE_PATH_STM32_TIM3 DEVICE_PATH_STM32 "TIM3"
...
typedef enum {
    ...
    STM32_TIM3_PORT_UNDEFINED = 0xFF,
} stm32_tim3_index_t;

// ----------------------------------------------------------------------------

#define TYPE_STM32_TIM3 TYPE_STM32_PREFIX "tim3" TYPE_PERIPHERAL_SUFFIX
