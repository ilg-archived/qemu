...
union {
      ...
      struct {
        // F0IWDG(Independent watchdog) registers.
        struct { 
...
// SR(Status register) bitfields.
          struct { 
Object *pvu; // [0:0] Watchdog prescaler value updateObject *rvu; // [1:1] Watchdog counter reload value updateObject *wvu; // [2:2] Watchdog counter window value update} sr; 
// WINR(Window register) bitfields.
          struct { 
Object *win; // [0:11] Watchdog counter window value} winr; 
} fld;
      } f0;
