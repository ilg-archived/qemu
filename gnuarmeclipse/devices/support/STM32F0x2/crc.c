...
static void stm32f0x2_crc_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
static void stm32_crc_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F0:
        ...
        if (capabilities->f0.is_0x2) {
            ...
            stm32f0x2_crc_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            // TODO: add callbacks.
            // peripheral_register_set_pre_read(state->f0.reg.xxx, &stm32_crc_xxx_pre_read_callback);
            // peripheral_register_set_post_read(state->f0.reg.xxx, &stm32_crc_xxx_post_read_callback);
            // peripheral_register_set_pre_read(state->f0.reg.xxx, &stm32_crc_xxx_pret_read_callback);
            // peripheral_register_set_post_write(state->f0.reg.xxx, &stm32_crc_xxx_post_write_callback);
