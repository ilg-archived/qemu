...
union {
      ...
      struct {
        // F4TIM1(Advanced-timers) registers.
        struct { 
...
// CCR3(Capture/compare register 3) bitfields.
          struct { 
Object *ccr3; // [0:15] Capture/Compare value} ccr3; 
// CCR4(Capture/compare register 4) bitfields.
          struct { 
Object *ccr4; // [0:15] Capture/Compare value} ccr4; 
