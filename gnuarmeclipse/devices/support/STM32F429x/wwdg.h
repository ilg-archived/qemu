...
union {
      ...
      struct {
        // F4WWDG(Window watchdog) registers.
        struct { 
...
// CR(Control register) bitfields.
          struct { 
Object *t; // [0:6] 7-bit counter (MSB to LSB)Object *wdga; // [7:7] Activation bit} cr; 
// CFR(Configuration register) bitfields.
          struct { 
Object *w; // [0:6] 7-bit window valueObject *wdgtb0; // [7:7] Timer baseObject *wdgtb1; // [8:8] Timer baseObject *ewi; // [9:9] Early wakeup interrupt} cfr; 
