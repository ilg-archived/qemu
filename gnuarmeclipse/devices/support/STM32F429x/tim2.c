...
static void stm32f429x_tim2_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
// ORbitfields.
state->u.f4.fld.or_.itr1_rmp= cm_object_get_child_by_name(state->u.f4.reg.or_, "ITR1_RMP"); 
}
...
static void stm32_tim2_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_429x) {
            ...
            stm32f429x_tim2_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            // TODO: add callbacks.
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_tim2_xxx_pre_read_callback);
            // peripheral_register_set_post_read(state->f4.reg.xxx, &stm32_tim2_xxx_post_read_callback);
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_tim2_xxx_pret_read_callback);
            // peripheral_register_set_post_write(state->f4.reg.xxx, &stm32_tim2_xxx_post_write_callback);
