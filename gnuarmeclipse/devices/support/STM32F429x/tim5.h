...
#define DEVICE_PATH_STM32_TIM5DEVICE_PATH_STM32"TIM5"

// ----------------------------------------------------------------------------

#define TYPE_STM32_TIM5TYPE_STM32_PREFIX "tim5" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F4TIM5(General-purpose-timers) registers.
        struct { 
...
// OR(TIM5 option register) bitfields.
          struct { 
Object *it4_rmp; // [6:7] Timer Input 4 remap} or_; 
} fld;
      } f4;
