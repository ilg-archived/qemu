...
// CIR(Clock interrupt register) bitfields.
          struct { 
Object *lsirdyf; // [0:0] LSI ready interrupt flagObject *lserdyf; // [1:1] LSE ready interrupt flagObject *hsirdyf; // [2:2] HSI ready interrupt flagObject *hserdyf; // [3:3] HSE ready interrupt flagObject *pllrdyf; // [4:4] Main PLL (PLL) ready interrupt flagObject *plli2srdyf; // [5:5] PLLI2S ready interrupt flagObject *pllsairdyf; // [6:6] PLLSAI ready interrupt flagObject *cssf; // [7:7] Clock security system interrupt flagObject *lsirdyie; // [8:8] LSI ready interrupt enableObject *lserdyie; // [9:9] LSE ready interrupt enableObject *hsirdyie; // [10:10] HSI ready interrupt enableObject *hserdyie; // [11:11] HSE ready interrupt enableObject *pllrdyie; // [12:12] Main PLL (PLL) ready interrupt enableObject *plli2srdyie; // [13:13] PLLI2S ready interrupt enableObject *pllsairdyie; // [14:14] PLLSAI Ready Interrupt EnableObject *lsirdyc; // [16:16] LSI ready interrupt clearObject *lserdyc; // [17:17] LSE ready interrupt clearObject *hsirdyc; // [18:18] HSI ready interrupt clearObject *hserdyc; // [19:19] HSE ready interrupt clearObject *pllrdyc; // [20:20] Main PLL(PLL) ready interrupt clearObject *plli2srdyc; // [21:21] PLLI2S ready interrupt clearObject *pllsairdyc; // [22:22] PLLSAI Ready Interrupt ClearObject *cssc; // [23:23] Clock security system interrupt clear} cir; 
// AHB1RSTR(AHB1 peripheral reset register) bitfields.
          struct { 
Object *gpioarst; // [0:0] IO port A resetObject *gpiobrst; // [1:1] IO port B resetObject *gpiocrst; // [2:2] IO port C resetObject *gpiodrst; // [3:3] IO port D resetObject *gpioerst; // [4:4] IO port E resetObject *gpiofrst; // [5:5] IO port F resetObject *gpiogrst; // [6:6] IO port G resetObject *gpiohrst; // [7:7] IO port H resetObject *gpioirst; // [8:8] IO port I resetObject *gpiojrst; // [9:9] IO port J resetObject *gpiokrst; // [10:10] IO port K resetObject *crcrst; // [12:12] CRC resetObject *dma1rst; // [21:21] DMA2 resetObject *dma2rst; // [22:22] DMA2 resetObject *dma2drst; // [23:23] DMA2D resetObject *ethmacrst; // [25:25] Ethernet MAC resetObject *otghsrst; // [29:29] USB OTG HS module reset} ahb1rstr; 
...
// AHB3RSTR(AHB3 peripheral reset register) bitfields.
          struct { 
Object *fmcrst; // [0:0] Flexible memory controller module reset} ahb3rstr; 
// APB1RSTR(APB1 peripheral reset register) bitfields.
          struct { 
Object *tim2rst; // [0:0] TIM2 resetObject *tim3rst; // [1:1] TIM3 resetObject *tim4rst; // [2:2] TIM4 resetObject *tim5rst; // [3:3] TIM5 resetObject *tim6rst; // [4:4] TIM6 resetObject *tim7rst; // [5:5] TIM7 resetObject *tim12rst; // [6:6] TIM12 resetObject *tim13rst; // [7:7] TIM13 resetObject *tim14rst; // [8:8] TIM14 resetObject *wwdgrst; // [11:11] Window watchdog resetObject *spi2rst; // [14:14] SPI 2 resetObject *spi3rst; // [15:15] SPI 3 resetObject *uart2rst; // [17:17] USART 2 resetObject *uart3rst; // [18:18] USART 3 resetObject *uart4rst; // [19:19] USART 4 resetObject *uart5rst; // [20:20] USART 5 resetObject *i2c1rst; // [21:21] I2C 1 resetObject *i2c2rst; // [22:22] I2C 2 resetObject *i2c3rst; // [23:23] I2C3 resetObject *can1rst; // [25:25] CAN1 resetObject *can2rst; // [26:26] CAN2 resetObject *pwrrst; // [28:28] Power interface resetObject *dacrst; // [29:29] DAC resetObject *uart7rst; // [30:30] UART7 resetObject *uart8rst; // [31:31] UART8 reset} apb1rstr; 
// APB2RSTR(APB2 peripheral reset register) bitfields.
          struct { 
Object *tim1rst; // [0:0] TIM1 resetObject *tim8rst; // [1:1] TIM8 resetObject *usart1rst; // [4:4] USART1 resetObject *usart6rst; // [5:5] USART6 resetObject *adcrst; // [8:8] ADC interface reset (common to all ADCs)Object *sdiorst; // [11:11] SDIO resetObject *spi1rst; // [12:12] SPI 1 resetObject *spi4rst; // [13:13] SPI4 resetObject *syscfgrst; // [14:14] System configuration controller resetObject *tim9rst; // [16:16] TIM9 resetObject *tim10rst; // [17:17] TIM10 resetObject *tim11rst; // [18:18] TIM11 resetObject *spi5rst; // [20:20] SPI5 resetObject *spi6rst; // [21:21] SPI6 resetObject *sai1rst; // [22:22] SAI1 resetObject *ltdcrst; // [26:26] LTDC reset} apb2rstr; 
// AHB1ENR(AHB1 peripheral clock register) bitfields.
          struct { 
Object *gpioaen; // [0:0] IO port A clock enableObject *gpioben; // [1:1] IO port B clock enableObject *gpiocen; // [2:2] IO port C clock enableObject *gpioden; // [3:3] IO port D clock enableObject *gpioeen; // [4:4] IO port E clock enableObject *gpiofen; // [5:5] IO port F clock enableObject *gpiogen; // [6:6] IO port G clock enableObject *gpiohen; // [7:7] IO port H clock enableObject *gpioien; // [8:8] IO port I clock enableObject *gpiojen; // [9:9] IO port J clock enableObject *gpioken; // [10:10] IO port K clock enableObject *crcen; // [12:12] CRC clock enableObject *bkpsramen; // [18:18] Backup SRAM interface clock enableObject *ccmdataramen; // [20:20] CCM data RAM clock enableObject *dma1en; // [21:21] DMA1 clock enableObject *dma2en; // [22:22] DMA2 clock enableObject *dma2den; // [23:23] DMA2D clock enableObject *ethmacen; // [25:25] Ethernet MAC clock enableObject *ethmactxen; // [26:26] Ethernet Transmission clock enableObject *ethmacrxen; // [27:27] Ethernet Reception clock enableObject *ethmacptpen; // [28:28] Ethernet PTP clock enableObject *otghsen; // [29:29] USB OTG HS clock enableObject *otghsulpien; // [30:30] USB OTG HSULPI clock enable} ahb1enr; 
...
// AHB3ENR(AHB3 peripheral clock enable register) bitfields.
          struct { 
Object *fmcen; // [0:0] Flexible memory controller module clock enable} ahb3enr; 
// APB1ENR(APB1 peripheral clock enable register) bitfields.
          struct { 
Object *tim2en; // [0:0] TIM2 clock enableObject *tim3en; // [1:1] TIM3 clock enableObject *tim4en; // [2:2] TIM4 clock enableObject *tim5en; // [3:3] TIM5 clock enableObject *tim6en; // [4:4] TIM6 clock enableObject *tim7en; // [5:5] TIM7 clock enableObject *tim12en; // [6:6] TIM12 clock enableObject *tim13en; // [7:7] TIM13 clock enableObject *tim14en; // [8:8] TIM14 clock enableObject *wwdgen; // [11:11] Window watchdog clock enableObject *spi2en; // [14:14] SPI2 clock enableObject *spi3en; // [15:15] SPI3 clock enableObject *usart2en; // [17:17] USART 2 clock enableObject *usart3en; // [18:18] USART3 clock enableObject *uart4en; // [19:19] UART4 clock enableObject *uart5en; // [20:20] UART5 clock enableObject *i2c1en; // [21:21] I2C1 clock enableObject *i2c2en; // [22:22] I2C2 clock enableObject *i2c3en; // [23:23] I2C3 clock enableObject *can1en; // [25:25] CAN 1 clock enableObject *can2en; // [26:26] CAN 2 clock enableObject *pwren; // [28:28] Power interface clock enableObject *dacen; // [29:29] DAC interface clock enableObject *uart7enr; // [30:30] UART7 clock enableObject *uart8enr; // [31:31] UART8 clock enable} apb1enr; 
// APB2ENR(APB2 peripheral clock enable register) bitfields.
          struct { 
Object *tim1en; // [0:0] TIM1 clock enableObject *tim8en; // [1:1] TIM8 clock enableObject *usart1en; // [4:4] USART1 clock enableObject *usart6en; // [5:5] USART6 clock enableObject *adc1en; // [8:8] ADC1 clock enableObject *adc2en; // [9:9] ADC2 clock enableObject *adc3en; // [10:10] ADC3 clock enableObject *sdioen; // [11:11] SDIO clock enableObject *spi1en; // [12:12] SPI1 clock enableObject *spi4enr; // [13:13] SPI4 clock enableObject *syscfgen; // [14:14] System configuration controller clock enableObject *tim9en; // [16:16] TIM9 clock enableObject *tim10en; // [17:17] TIM10 clock enableObject *tim11en; // [18:18] TIM11 clock enableObject *spi5enr; // [20:20] SPI5 clock enableObject *spi6enr; // [21:21] SPI6 clock enableObject *sai1en; // [22:22] SAI1 clock enableObject *ltdcen; // [26:26] LTDC clock enable} apb2enr; 
// AHB1LPENR(AHB1 peripheral clock enable in low power mode register) bitfields.
          struct { 
Object *gpioalpen; // [0:0] IO port A clock enable during sleep modeObject *gpioblpen; // [1:1] IO port B clock enable during Sleep modeObject *gpioclpen; // [2:2] IO port C clock enable during Sleep modeObject *gpiodlpen; // [3:3] IO port D clock enable during Sleep modeObject *gpioelpen; // [4:4] IO port E clock enable during Sleep modeObject *gpioflpen; // [5:5] IO port F clock enable during Sleep modeObject *gpioglpen; // [6:6] IO port G clock enable during Sleep modeObject *gpiohlpen; // [7:7] IO port H clock enable during Sleep modeObject *gpioilpen; // [8:8] IO port I clock enable during Sleep modeObject *gpiojlpen; // [9:9] IO port J clock enable during Sleep modeObject *gpioklpen; // [10:10] IO port K clock enable during Sleep modeObject *crclpen; // [12:12] CRC clock enable during Sleep modeObject *flitflpen; // [15:15] Flash interface clock enable during Sleep modeObject *sram1lpen; // [16:16] SRAM 1interface clock enable during Sleep modeObject *sram2lpen; // [17:17] SRAM 2 interface clock enable during Sleep modeObject *bkpsramlpen; // [18:18] Backup SRAM interface clock enable during Sleep modeObject *sram3lpen; // [19:19] SRAM 3 interface clock enable during Sleep modeObject *dma1lpen; // [21:21] DMA1 clock enable during Sleep modeObject *dma2lpen; // [22:22] DMA2 clock enable during Sleep modeObject *dma2dlpen; // [23:23] DMA2D clock enable during Sleep modeObject *ethmaclpen; // [25:25] Ethernet MAC clock enable during Sleep modeObject *ethmactxlpen; // [26:26] Ethernet transmission clock enable during Sleep modeObject *ethmacrxlpen; // [27:27] Ethernet reception clock enable during Sleep modeObject *ethmacptplpen; // [28:28] Ethernet PTP clock enable during Sleep modeObject *otghslpen; // [29:29] USB OTG HS clock enable during Sleep modeObject *otghsulpilpen; // [30:30] USB OTG HS ULPI clock enable during Sleep mode} ahb1lpenr; 
...
// PLLI2SCFGR(PLLI2S configuration register) bitfields.
          struct { 
Object *plli2sn; // [6:14] PLLI2S multiplication factor for VCOObject *plli2sq; // [24:27] PLLI2S division factor for SAI1 clockObject *plli2sr; // [28:30] PLLI2S division factor for I2S clocks} plli2scfgr; 
// PLLSAICFGR(PLLSAICFGR) bitfields.
          struct { 
Object *pllsain; // [6:14] PLLSAINObject *pllsaiq; // [24:27] PLLSAINObject *pllsair; // [28:30] PLLSAIN} pllsaicfgr; 
// DCKCFGR(DCKCFGR) bitfields.
          struct { 
Object *plli2sdivq; // [0:4] PLLI2SDIVQObject *pllsaidivq; // [8:12] PLLSAIDIVQObject *pllsaidivr; // [16:17] PLLSAIDIVRObject *sai1asrc; // [20:21] SAI1ASRCObject *sai1bsrc; // [22:23] SAI1BSRCObject *timpre; // [24:24] TIMPRE} dckcfgr; 
} fld;
      } f4;
