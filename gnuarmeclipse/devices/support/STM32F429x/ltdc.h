...
#define DEVICE_PATH_STM32_LTDCDEVICE_PATH_STM32"LTDC"

// ----------------------------------------------------------------------------

#define TYPE_STM32_LTDCTYPE_STM32_PREFIX "ltdc" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F4LTDC(LCD-TFT Controller) registers.
        struct { 
...
// SSCR(Synchronization Size Configuration Register) bitfields.
          struct { 
Object *vsh; // [0:10] Vertical Synchronization Height (in units of horizontal scan line)Object *hsw; // [16:27] Horizontal Synchronization Width (in units of pixel clock period)} sscr; 
// BPCR(Back Porch Configuration Register) bitfields.
          struct { 
Object *avbp; // [0:10] Accumulated Vertical back porch (in units of horizontal scan line)Object *ahbp; // [16:27] Accumulated Horizontal back porch (in units of pixel clock period)} bpcr; 
// AWCR(Active Width Configuration Register) bitfields.
          struct { 
Object *aah; // [0:10] Accumulated Active Height (in units of horizontal scan line)Object *aaw; // [16:27] Accumulated Active Width (in units of pixel clock period)} awcr; 
// TWCR(Total Width Configuration Register) bitfields.
          struct { 
Object *totalh; // [0:10] Total Height (in units of horizontal scan line)Object *totalw; // [16:27] Total Width (in units of pixel clock period)} twcr; 
// GCR(Global Control Register) bitfields.
          struct { 
Object *ltdcen; // [0:0] LCD-TFT controller enable bitObject *dbw; // [4:6] Dither Blue WidthObject *dgw; // [8:10] Dither Green WidthObject *drw; // [12:14] Dither Red WidthObject *den; // [16:16] Dither EnableObject *pcpol; // [28:28] Pixel Clock PolarityObject *depol; // [29:29] Data Enable PolarityObject *vspol; // [30:30] Vertical Synchronization PolarityObject *hspol; // [31:31] Horizontal Synchronization Polarity} gcr; 
// SRCR(Shadow Reload Configuration Register) bitfields.
          struct { 
Object *imr; // [0:0] Immediate ReloadObject *vbr; // [1:1] Vertical Blanking Reload} srcr; 
// BCCR(Background Color Configuration Register) bitfields.
          struct { 
Object *bc; // [0:23] Background Color Red value} bccr; 
// IER(Interrupt Enable Register) bitfields.
          struct { 
Object *lie; // [0:0] Line Interrupt EnableObject *fuie; // [1:1] FIFO Underrun Interrupt EnableObject *terrie; // [2:2] Transfer Error Interrupt EnableObject *rrie; // [3:3] Register Reload interrupt enable} ier; 
// ISR(Interrupt Status Register) bitfields.
          struct { 
Object *lif; // [0:0] Line Interrupt flagObject *fuif; // [1:1] FIFO Underrun Interrupt flagObject *terrif; // [2:2] Transfer Error interrupt flagObject *rrif; // [3:3] Register Reload Interrupt Flag} isr; 
// ICR(Interrupt Clear Register) bitfields.
          struct { 
Object *clif; // [0:0] Clears the Line Interrupt FlagObject *cfuif; // [1:1] Clears the FIFO Underrun Interrupt flagObject *cterrif; // [2:2] Clears the Transfer Error Interrupt FlagObject *crrif; // [3:3] Clears Register Reload Interrupt Flag} icr; 
// LIPCR(Line Interrupt Position Configuration Register) bitfields.
          struct { 
Object *lipos; // [0:10] Line Interrupt Position} lipcr; 
// CPSR(Current Position Status Register) bitfields.
          struct { 
Object *cypos; // [0:15] Current Y PositionObject *cxpos; // [16:31] Current X Position} cpsr; 
// CDSR(Current Display Status Register) bitfields.
          struct { 
Object *vdes; // [0:0] Vertical Data Enable display StatusObject *hdes; // [1:1] Horizontal Data Enable display StatusObject *vsyncs; // [2:2] Vertical Synchronization display StatusObject *hsyncs; // [3:3] Horizontal Synchronization display Status} cdsr; 
// L1CR(Layerx Control Register) bitfields.
          struct { 
Object *len; // [0:0] Layer EnableObject *colken; // [1:1] Color Keying EnableObject *cluten; // [4:4] Color Look-Up Table Enable} l1cr; 
// L1WHPCR(Layerx Window Horizontal Position Configuration Register) bitfields.
          struct { 
Object *whstpos; // [0:11] Window Horizontal Start PositionObject *whsppos; // [16:27] Window Horizontal Stop Position} l1whpcr; 
// L1WVPCR(Layerx Window Vertical Position Configuration Register) bitfields.
          struct { 
Object *wvstpos; // [0:10] Window Vertical Start PositionObject *wvsppos; // [16:26] Window Vertical Stop Position} l1wvpcr; 
// L1CKCR(Layerx Color Keying Configuration Register) bitfields.
          struct { 
Object *ckblue; // [0:7] Color Key Blue valueObject *ckgreen; // [8:15] Color Key Green valueObject *ckred; // [16:23] Color Key Red value} l1ckcr; 
// L1PFCR(Layerx Pixel Format Configuration Register) bitfields.
          struct { 
Object *pf; // [0:2] Pixel Format} l1pfcr; 
// L1CACR(Layerx Constant Alpha Configuration Register) bitfields.
          struct { 
Object *consta; // [0:7] Constant Alpha} l1cacr; 
// L1DCCR(Layerx Default Color Configuration Register) bitfields.
          struct { 
Object *dcblue; // [0:7] Default Color BlueObject *dcgreen; // [8:15] Default Color GreenObject *dcred; // [16:23] Default Color RedObject *dcalpha; // [24:31] Default Color Alpha} l1dccr; 
// L1BFCR(Layerx Blending Factors Configuration Register) bitfields.
          struct { 
Object *bf2; // [0:2] Blending Factor 2Object *bf1; // [8:10] Blending Factor 1} l1bfcr; 
// L1CFBAR(Layerx Color Frame Buffer Address Register) bitfields.
          struct { 
Object *cfbadd; // [0:31] Color Frame Buffer Start Address} l1cfbar; 
// L1CFBLR(Layerx Color Frame Buffer Length Register) bitfields.
          struct { 
Object *cfbll; // [0:12] Color Frame Buffer Line LengthObject *cfbp; // [16:28] Color Frame Buffer Pitch in bytes} l1cfblr; 
// L1CFBLNR(Layerx ColorFrame Buffer Line Number Register) bitfields.
          struct { 
Object *cfblnbr; // [0:10] Frame Buffer Line Number} l1cfblnr; 
// L1CLUTWR(Layerx CLUT Write Register) bitfields.
          struct { 
Object *blue; // [0:7] Blue valueObject *green; // [8:15] Green valueObject *red; // [16:23] Red valueObject *clutadd; // [24:31] CLUT Address} l1clutwr; 
// L2CR(Layerx Control Register) bitfields.
          struct { 
Object *len; // [0:0] Layer EnableObject *colken; // [1:1] Color Keying EnableObject *cluten; // [4:4] Color Look-Up Table Enable} l2cr; 
// L2WHPCR(Layerx Window Horizontal Position Configuration Register) bitfields.
          struct { 
Object *whstpos; // [0:11] Window Horizontal Start PositionObject *whsppos; // [16:27] Window Horizontal Stop Position} l2whpcr; 
// L2WVPCR(Layerx Window Vertical Position Configuration Register) bitfields.
          struct { 
Object *wvstpos; // [0:10] Window Vertical Start PositionObject *wvsppos; // [16:26] Window Vertical Stop Position} l2wvpcr; 
// L2CKCR(Layerx Color Keying Configuration Register) bitfields.
          struct { 
Object *ckblue; // [0:7] Color Key Blue valueObject *ckgreen; // [8:14] Color Key Green valueObject *ckred; // [15:23] Color Key Red value} l2ckcr; 
// L2PFCR(Layerx Pixel Format Configuration Register) bitfields.
          struct { 
Object *pf; // [0:2] Pixel Format} l2pfcr; 
// L2CACR(Layerx Constant Alpha Configuration Register) bitfields.
          struct { 
Object *consta; // [0:7] Constant Alpha} l2cacr; 
// L2DCCR(Layerx Default Color Configuration Register) bitfields.
          struct { 
Object *dcblue; // [0:7] Default Color BlueObject *dcgreen; // [8:15] Default Color GreenObject *dcred; // [16:23] Default Color RedObject *dcalpha; // [24:31] Default Color Alpha} l2dccr; 
// L2BFCR(Layerx Blending Factors Configuration Register) bitfields.
          struct { 
Object *bf2; // [0:2] Blending Factor 2Object *bf1; // [8:10] Blending Factor 1} l2bfcr; 
// L2CFBAR(Layerx Color Frame Buffer Address Register) bitfields.
          struct { 
Object *cfbadd; // [0:31] Color Frame Buffer Start Address} l2cfbar; 
// L2CFBLR(Layerx Color Frame Buffer Length Register) bitfields.
          struct { 
Object *cfbll; // [0:12] Color Frame Buffer Line LengthObject *cfbp; // [16:28] Color Frame Buffer Pitch in bytes} l2cfblr; 
// L2CFBLNR(Layerx ColorFrame Buffer Line Number Register) bitfields.
          struct { 
Object *cfblnbr; // [0:10] Frame Buffer Line Number} l2cfblnr; 
// L2CLUTWR(Layerx CLUT Write Register) bitfields.
          struct { 
Object *blue; // [0:7] Blue valueObject *green; // [8:15] Green valueObject *red; // [16:23] Red valueObject *clutadd; // [24:31] CLUT Address} l2clutwr; 
} fld;
      } f4;
