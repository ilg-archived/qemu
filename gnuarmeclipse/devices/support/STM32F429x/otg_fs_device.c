...
static void stm32f429x_otg_fs_device_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
static void stm32_otg_fs_device_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_429x) {
            ...
            stm32f429x_otg_fs_device_create_objects(obj, cm_state->svd_json, periph_name);
