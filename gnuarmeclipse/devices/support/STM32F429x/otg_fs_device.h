...
#define DEVICE_PATH_STM32_OTG_FS_DEVICEDEVICE_PATH_STM32"OTG_FS_DEVICE"

// ----------------------------------------------------------------------------

#define TYPE_STM32_OTG_FS_DEVICETYPE_STM32_PREFIX "otg_fs_device" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F4OTG_FS_DEVICE(USB on the go full speed) registers.
        struct { 
