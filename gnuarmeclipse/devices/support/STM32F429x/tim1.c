...
static void stm32f429x_tim1_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
state->u.f4.reg.rcr= cm_object_get_child_by_name(obj, "RCR");
state->u.f4.reg.bdtr= cm_object_get_child_by_name(obj, "BDTR");
// CR1bitfields.
...
// CR2bitfields.
state->u.f4.fld.cr2.ccpc= cm_object_get_child_by_name(state->u.f4.reg.cr2, "CCPC"); 
state->u.f4.fld.cr2.ccus= cm_object_get_child_by_name(state->u.f4.reg.cr2, "CCUS"); 
...
state->u.f4.fld.cr2.ois1= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS1"); 
state->u.f4.fld.cr2.ois1n= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS1N"); 
state->u.f4.fld.cr2.ois2= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS2"); 
state->u.f4.fld.cr2.ois2n= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS2N"); 
state->u.f4.fld.cr2.ois3= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS3"); 
state->u.f4.fld.cr2.ois3n= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS3N"); 
state->u.f4.fld.cr2.ois4= cm_object_get_child_by_name(state->u.f4.reg.cr2, "OIS4"); 
// SMCRbitfields.
...
state->u.f4.fld.dier.comie= cm_object_get_child_by_name(state->u.f4.reg.dier, "COMIE"); 
state->u.f4.fld.dier.tie= cm_object_get_child_by_name(state->u.f4.reg.dier, "TIE"); 
state->u.f4.fld.dier.bie= cm_object_get_child_by_name(state->u.f4.reg.dier, "BIE"); 
...
state->u.f4.fld.dier.comde= cm_object_get_child_by_name(state->u.f4.reg.dier, "COMDE"); 
...
state->u.f4.fld.sr.comif= cm_object_get_child_by_name(state->u.f4.reg.sr, "COMIF"); 
state->u.f4.fld.sr.tif= cm_object_get_child_by_name(state->u.f4.reg.sr, "TIF"); 
state->u.f4.fld.sr.bif= cm_object_get_child_by_name(state->u.f4.reg.sr, "BIF"); 
...
state->u.f4.fld.egr.comg= cm_object_get_child_by_name(state->u.f4.reg.egr, "COMG"); 
state->u.f4.fld.egr.tg= cm_object_get_child_by_name(state->u.f4.reg.egr, "TG"); 
state->u.f4.fld.egr.bg= cm_object_get_child_by_name(state->u.f4.reg.egr, "BG"); 
...
state->u.f4.fld.ccmr2_output.oc4ce= cm_object_get_child_by_name(state->u.f4.reg.ccmr2_output, "OC4CE"); 
...
state->u.f4.fld.ccer.cc1ne= cm_object_get_child_by_name(state->u.f4.reg.ccer, "CC1NE"); 
...
state->u.f4.fld.ccer.cc2ne= cm_object_get_child_by_name(state->u.f4.reg.ccer, "CC2NE"); 
...
state->u.f4.fld.ccer.cc3ne= cm_object_get_child_by_name(state->u.f4.reg.ccer, "CC3NE"); 
...
// CCR3bitfields.
state->u.f4.fld.ccr3.ccr3= cm_object_get_child_by_name(state->u.f4.reg.ccr3, "CCR3"); 
// CCR4bitfields.
state->u.f4.fld.ccr4.ccr4= cm_object_get_child_by_name(state->u.f4.reg.ccr4, "CCR4"); 
// DCRbitfields.
...
// RCRbitfields.
state->u.f4.fld.rcr.rep= cm_object_get_child_by_name(state->u.f4.reg.rcr, "REP"); 
// BDTRbitfields.
state->u.f4.fld.bdtr.dtg= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "DTG"); 
state->u.f4.fld.bdtr.lock= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "LOCK"); 
state->u.f4.fld.bdtr.ossi= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "OSSI"); 
state->u.f4.fld.bdtr.ossr= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "OSSR"); 
state->u.f4.fld.bdtr.bke= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "BKE"); 
state->u.f4.fld.bdtr.bkp= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "BKP"); 
state->u.f4.fld.bdtr.aoe= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "AOE"); 
state->u.f4.fld.bdtr.moe= cm_object_get_child_by_name(state->u.f4.reg.bdtr, "MOE"); 
}
...
static void stm32_tim1_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_429x) {
            ...
            stm32f429x_tim1_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            // TODO: add callbacks.
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_tim1_xxx_pre_read_callback);
            // peripheral_register_set_post_read(state->f4.reg.xxx, &stm32_tim1_xxx_post_read_callback);
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_tim1_xxx_pret_read_callback);
            // peripheral_register_set_post_write(state->f4.reg.xxx, &stm32_tim1_xxx_post_write_callback);
