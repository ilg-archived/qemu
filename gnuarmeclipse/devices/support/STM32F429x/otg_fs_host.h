...
#ifndef STM32_OTG_FS_HOST_H_
#define STM32_OTG_FS_HOST_H_
...
#define DEVICE_PATH_STM32_OTG_FS_HOSTDEVICE_PATH_STM32"OTG_FS_HOST"

// ----------------------------------------------------------------------------

#define TYPE_STM32_OTG_FS_HOSTTYPE_STM32_PREFIX "otg_fs_host" TYPE_PERIPHERAL_SUFFIX

// ----------------------------------------------------------------------------

// Parent definitions.
#define TYPE_STM32_OTG_FS_HOST_PARENT TYPE_PERIPHERAL
typedef PeripheralClass STM32OTG_FS_HOSTParentClass;
typedef PeripheralState STM32OTG_FS_HOSTParentState;

// ----------------------------------------------------------------------------

// Class definitions.
#define STM32_OTG_FS_HOST_GET_CLASS(obj) \
    OBJECT_GET_CLASS(STM32OTG_FS_HOSTClass, (obj), TYPE_STM32_OTG_FS_HOST)
#define STM32_OTG_FS_HOST_CLASS(klass) \
    OBJECT_CLASS_CHECK(STM32OTG_FS_HOSTClass, (klass), TYPE_STM32_OTG_FS_HOST)

typedef struct {
    // private: 
    STM32OTG_FS_HOSTParentClass parent_class;
    // public: 

    // None, so far.
} STM32OTG_FS_HOSTClass;

// ----------------------------------------------------------------------------

// Instance definitions.
#define STM32_OTG_FS_HOST_STATE(obj) \
    OBJECT_CHECK(STM32OTG_FS_HOSTState, (obj), TYPE_STM32_OTG_FS_HOST)

typedef struct {
    // private:
    STM32OTG_FS_HOSTParentState parent_obj;
    // public:
...
union {
      ...
      struct {
        // F4OTG_FS_HOST(USB on the go full speed) registers.
        struct { 
...
// FS_HCFG(OTG_FS host configuration register (OTG_FS_HCFG)) bitfields.
          struct { 
Object *fslspcs; // [0:1] FS/LS PHY clock selectObject *fslss; // [2:2] FS- and LS-only support} fs_hcfg; 
// HFIR(OTG_FS Host frame interval register) bitfields.
          struct { 
Object *frivl; // [0:15] Frame interval} hfir; 
// FS_HFNUM(OTG_FS host frame number/frame time remaining register (OTG_FS_HFNUM)) bitfields.
          struct { 
Object *frnum; // [0:15] Frame numberObject *ftrem; // [16:31] Frame time remaining} fs_hfnum; 
// FS_HPTXSTS(OTG_FS_Host periodic transmit FIFO/queue status register (OTG_FS_HPTXSTS)) bitfields.
          struct { 
Object *ptxfsavl; // [0:15] Periodic transmit data FIFO space availableObject *ptxqsav; // [16:23] Periodic transmit request queue space availableObject *ptxqtop; // [24:31] Top of the periodic transmit request queue} fs_hptxsts; 
// HAINT(OTG_FS Host all channels interrupt register) bitfields.
          struct { 
Object *haint; // [0:15] Channel interrupts} haint; 
// HAINTMSK(OTG_FS host all channels interrupt mask register) bitfields.
          struct { 
Object *haintm; // [0:15] Channel interrupt mask} haintmsk; 
...
// FS_HCCHAR0(OTG_FS host channel-0 characteristics register (OTG_FS_HCCHAR0)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar0; 
// FS_HCCHAR1(OTG_FS host channel-1 characteristics register (OTG_FS_HCCHAR1)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar1; 
// FS_HCCHAR2(OTG_FS host channel-2 characteristics register (OTG_FS_HCCHAR2)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar2; 
// FS_HCCHAR3(OTG_FS host channel-3 characteristics register (OTG_FS_HCCHAR3)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar3; 
// FS_HCCHAR4(OTG_FS host channel-4 characteristics register (OTG_FS_HCCHAR4)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar4; 
// FS_HCCHAR5(OTG_FS host channel-5 characteristics register (OTG_FS_HCCHAR5)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar5; 
// FS_HCCHAR6(OTG_FS host channel-6 characteristics register (OTG_FS_HCCHAR6)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar6; 
// FS_HCCHAR7(OTG_FS host channel-7 characteristics register (OTG_FS_HCCHAR7)) bitfields.
          struct { 
Object *mpsiz; // [0:10] Maximum packet sizeObject *epnum; // [11:14] Endpoint numberObject *epdir; // [15:15] Endpoint directionObject *lsdev; // [17:17] Low-speed deviceObject *eptyp; // [18:19] Endpoint typeObject *mcnt; // [20:21] MulticountObject *dad; // [22:28] Device addressObject *oddfrm; // [29:29] Odd frameObject *chdis; // [30:30] Channel disableObject *chena; // [31:31] Channel enable} fs_hcchar7; 
// FS_HCINT0(OTG_FS host channel-0 interrupt register (OTG_FS_HCINT0)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint0; 
// FS_HCINT1(OTG_FS host channel-1 interrupt register (OTG_FS_HCINT1)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint1; 
// FS_HCINT2(OTG_FS host channel-2 interrupt register (OTG_FS_HCINT2)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint2; 
// FS_HCINT3(OTG_FS host channel-3 interrupt register (OTG_FS_HCINT3)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint3; 
// FS_HCINT4(OTG_FS host channel-4 interrupt register (OTG_FS_HCINT4)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint4; 
// FS_HCINT5(OTG_FS host channel-5 interrupt register (OTG_FS_HCINT5)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint5; 
// FS_HCINT6(OTG_FS host channel-6 interrupt register (OTG_FS_HCINT6)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint6; 
// FS_HCINT7(OTG_FS host channel-7 interrupt register (OTG_FS_HCINT7)) bitfields.
          struct { 
Object *xfrc; // [0:0] Transfer completedObject *chh; // [1:1] Channel haltedObject *stall; // [3:3] STALL response received interruptObject *nak; // [4:4] NAK response received interruptObject *ack; // [5:5] ACK response received/transmitted interruptObject *txerr; // [7:7] Transaction errorObject *bberr; // [8:8] Babble errorObject *frmor; // [9:9] Frame overrunObject *dterr; // [10:10] Data toggle error} fs_hcint7; 
// FS_HCINTMSK0(OTG_FS host channel-0 mask register (OTG_FS_HCINTMSK0)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk0; 
// FS_HCINTMSK1(OTG_FS host channel-1 mask register (OTG_FS_HCINTMSK1)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk1; 
// FS_HCINTMSK2(OTG_FS host channel-2 mask register (OTG_FS_HCINTMSK2)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk2; 
// FS_HCINTMSK3(OTG_FS host channel-3 mask register (OTG_FS_HCINTMSK3)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk3; 
// FS_HCINTMSK4(OTG_FS host channel-4 mask register (OTG_FS_HCINTMSK4)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk4; 
// FS_HCINTMSK5(OTG_FS host channel-5 mask register (OTG_FS_HCINTMSK5)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk5; 
// FS_HCINTMSK6(OTG_FS host channel-6 mask register (OTG_FS_HCINTMSK6)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk6; 
// FS_HCINTMSK7(OTG_FS host channel-7 mask register (OTG_FS_HCINTMSK7)) bitfields.
          struct { 
Object *xfrcm; // [0:0] Transfer completed maskObject *chhm; // [1:1] Channel halted maskObject *stallm; // [3:3] STALL response received interrupt maskObject *nakm; // [4:4] NAK response received interrupt maskObject *ackm; // [5:5] ACK response received/transmitted interrupt maskObject *nyet; // [6:6] Response received interrupt maskObject *txerrm; // [7:7] Transaction error maskObject *bberrm; // [8:8] Babble error maskObject *frmorm; // [9:9] Frame overrun maskObject *dterrm; // [10:10] Data toggle error mask} fs_hcintmsk7; 
// FS_HCTSIZ0(OTG_FS host channel-0 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz0; 
// FS_HCTSIZ1(OTG_FS host channel-1 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz1; 
// FS_HCTSIZ2(OTG_FS host channel-2 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz2; 
// FS_HCTSIZ3(OTG_FS host channel-3 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz3; 
// FS_HCTSIZ4(OTG_FS host channel-x transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz4; 
// FS_HCTSIZ5(OTG_FS host channel-5 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz5; 
// FS_HCTSIZ6(OTG_FS host channel-6 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz6; 
// FS_HCTSIZ7(OTG_FS host channel-7 transfer size register) bitfields.
          struct { 
Object *xfrsiz; // [0:18] Transfer sizeObject *pktcnt; // [19:28] Packet countObject *dpid; // [29:30] Data PID} fs_hctsiz7; 
} fld;
      } f4;
