...
union {
      ...
      struct {
        // F4UART(Universal synchronous asynchronous receiver transmitter) registers.
        struct { 
...
// CR3(Control register 3) bitfields.
          struct { 
Object *eie; // [0:0] Error interrupt enableObject *iren; // [1:1] IrDA mode enableObject *irlp; // [2:2] IrDA low-powerObject *hdsel; // [3:3] Half-duplex selectionObject *dmar; // [6:6] DMA enable receiverObject *dmat; // [7:7] DMA enable transmitterObject *onebit; // [11:11] One sample bit method enable} cr3; 
} fld;
      } f4;
