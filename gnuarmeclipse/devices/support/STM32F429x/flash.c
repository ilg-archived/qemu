...
static void stm32f429x_flash_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.f4.fld.cr.mer1 = cm_object_get_child_by_name(state->u.f4.reg.cr, "MER1"); 
    ...
    // OPTCR1 bitfields.
    state->u.f4.fld.optcr1.nwrp = cm_object_get_child_by_name(state->u.f4.reg.optcr1, "nWRP");  
}
...
static void stm32_flash_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_429x ) {
            ...
            stm32f429x_flash_create_objects(obj, cm_state->svd_json, periph_name);
