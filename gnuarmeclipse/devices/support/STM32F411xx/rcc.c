...
static void stm32f411xx_rcc_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.f4.fld.apb2enr.spi4en = cm_object_get_child_by_name(state->u.f4.reg.apb2enr, "SPI4EN"); 
...
static void stm32_rcc_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_411xx ) {
            ...
            stm32f411xx_rcc_create_objects(obj, cm_state->svd_json, periph_name);
