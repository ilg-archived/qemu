...
typedef struct {
    ...
    /*
     * Mutually exclusive all families registers. Normally
     * this should have been a `union`, but this would complicate addresing.
     * Address them like status->f1.reg.crl.
