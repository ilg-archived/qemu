...
static void stm32f411xx_usart_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.f4.fld.sr.cts = cm_object_get_child_by_name(state->u.f4.reg.sr, "CTS");  
    ...
    state->u.f4.fld.cr2.lbcl = cm_object_get_child_by_name(state->u.f4.reg.cr2, "LBCL"); 
    state->u.f4.fld.cr2.cpha = cm_object_get_child_by_name(state->u.f4.reg.cr2, "CPHA"); 
    state->u.f4.fld.cr2.cpol = cm_object_get_child_by_name(state->u.f4.reg.cr2, "CPOL"); 
    state->u.f4.fld.cr2.clken = cm_object_get_child_by_name(state->u.f4.reg.cr2, "CLKEN"); 
    ...
    state->u.f4.fld.cr3.nack = cm_object_get_child_by_name(state->u.f4.reg.cr3, "NACK"); 
    state->u.f4.fld.cr3.scen = cm_object_get_child_by_name(state->u.f4.reg.cr3, "SCEN"); 
    ...
    state->u.f4.fld.cr3.rtse = cm_object_get_child_by_name(state->u.f4.reg.cr3, "RTSE"); 
    state->u.f4.fld.cr3.ctse = cm_object_get_child_by_name(state->u.f4.reg.cr3, "CTSE"); 
    state->u.f4.fld.cr3.ctsie = cm_object_get_child_by_name(state->u.f4.reg.cr3, "CTSIE"); 
    state->u.f4.fld.cr3.onebit = cm_object_get_child_by_name(state->u.f4.reg.cr3, "ONEBIT");  
    
    // GTPR bitfields.
    state->u.f4.fld.gtpr.psc = cm_object_get_child_by_name(state->u.f4.reg.gtpr, "PSC"); 
    state->u.f4.fld.gtpr.gt = cm_object_get_child_by_name(state->u.f4.reg.gtpr, "GT");  
}
...
static void stm32_usart_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_411xx ) {
            ...
            stm32f411xx_usart_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            // TODO: add callbacks.
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_usart_xxx_pre_read_callback);
            // peripheral_register_set_post_read(state->f4.reg.xxx, &stm32_usart_xxx_post_read_callback);
            // peripheral_register_set_pre_read(state->f4.reg.xxx, &stm32_usart_xxx_pret_read_callback);
            // peripheral_register_set_post_write(state->f4.reg.xxx, &stm32_usart_xxx_post_write_callback);
