...
static void stm32f411xx_rtc_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.f4.fld.cr.bypshad = cm_object_get_child_by_name(state->u.f4.reg.cr, "BYPSHAD"); 
    ...
    state->u.f4.fld.cr.cosel = cm_object_get_child_by_name(state->u.f4.reg.cr, "COSEL"); 
    ...
    // TSTR bitfields.
    state->u.f4.fld.tstr.su = cm_object_get_child_by_name(state->u.f4.reg.tstr, "SU"); 
    state->u.f4.fld.tstr.st = cm_object_get_child_by_name(state->u.f4.reg.tstr, "ST"); 
    state->u.f4.fld.tstr.mnu = cm_object_get_child_by_name(state->u.f4.reg.tstr, "MNU"); 
    state->u.f4.fld.tstr.mnt = cm_object_get_child_by_name(state->u.f4.reg.tstr, "MNT"); 
    state->u.f4.fld.tstr.hu = cm_object_get_child_by_name(state->u.f4.reg.tstr, "HU"); 
    state->u.f4.fld.tstr.ht = cm_object_get_child_by_name(state->u.f4.reg.tstr, "HT"); 
    state->u.f4.fld.tstr.pm = cm_object_get_child_by_name(state->u.f4.reg.tstr, "PM");  
...
static void stm32_rtc_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F4:
        ...
        if (capabilities->f4.is_411xx ) {
            ...
            stm32f411xx_rtc_create_objects(obj, cm_state->svd_json, periph_name);
