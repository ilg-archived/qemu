...
static void stm32f107xx_afio_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.f1.fld.mapr.can1_remap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "CAN1_REMAP"); 
    ...
    state->u.f1.fld.mapr.eth_remap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "ETH_REMAP"); 
    state->u.f1.fld.mapr.can2_remap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "CAN2_REMAP"); 
    state->u.f1.fld.mapr.mii_rmii_sel = cm_object_get_child_by_name(state->u.f1.reg.mapr, "MII_RMII_SEL"); 
    state->u.f1.fld.mapr.swj_cfg = cm_object_get_child_by_name(state->u.f1.reg.mapr, "SWJ_CFG"); 
    state->u.f1.fld.mapr.spi3_remap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "SPI3_REMAP"); 
    state->u.f1.fld.mapr.tim2itr1_iremap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "TIM2ITR1_IREMAP"); 
    state->u.f1.fld.mapr.ptp_pps_remap = cm_object_get_child_by_name(state->u.f1.reg.mapr, "PTP_PPS_REMAP");  
...
static void stm32_afio_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F1:
        ...
        if (capabilities->f1.is_107xx ) {
            ...
            stm32f107xx_afio_create_objects(obj, cm_state->svd_json, periph_name);
