...
static void stm32f107xx_uart_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
static void stm32_uart_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F1:
        ...
        if (capabilities->f1.is_107xx ) {
            ...
            stm32f107xx_uart_create_objects(obj, cm_state->svd_json, periph_name);
