...
static void stm32f40x_rcc_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    // AHB3RSTR bitfields.
    state->u.f4.fld.ahb3rstr.fsmcrst = cm_object_get_child_by_name(state->u.f4.reg.ahb3rstr, "FSMCRST");  
    ...
    // AHB3ENR bitfields.
    state->u.f4.fld.ahb3enr.fsmcen = cm_object_get_child_by_name(state->u.f4.reg.ahb3enr, "FSMCEN");  
    ...
    // AHB3LPENR bitfields.
    state->u.f4.fld.ahb3lpenr.fsmclpen = cm_object_get_child_by_name(state->u.f4.reg.ahb3lpenr, "FSMCLPEN");  
    ...
    state->u.f4.fld.plli2scfgr.plli2snx = cm_object_get_child_by_name(state->u.f4.reg.plli2scfgr, "PLLI2SNx"); 
    state->u.f4.fld.plli2scfgr.plli2srx = cm_object_get_child_by_name(state->u.f4.reg.plli2scfgr, "PLLI2SRx");  
}
