...
static void stm32f0x2_dbgmcu_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
...
static void stm32_dbgmcu_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case STM32_FAMILY_F0:
        ...
        if (capabilities->f0.is_0x2) {
            ...
            stm32f0x2_dbgmcu_create_objects(obj, cm_state->svd_json, periph_name);
