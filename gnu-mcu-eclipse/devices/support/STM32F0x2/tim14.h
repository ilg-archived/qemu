...
#define DEVICE_PATH_STM32_TIM14DEVICE_PATH_STM32"TIM14"

// ----------------------------------------------------------------------------

#define TYPE_STM32_TIM14TYPE_STM32_PREFIX "tim14" TYPE_PERIPHERAL_SUFFIX
...
union {
      ...
      struct {
        // F0TIM14(General-purpose-timers) registers.
        struct { 
...
// OR(Option register) bitfields.
          struct { 
Object *rmp; // [0:1] Timer input 1 remap} or_; 
} fld;
      } f0;
